...
public class FmKupacIzmena extends javax.swing.JFrame {

    /**
     * Creates new form FmKupacIzmena
     */
    FmKupac kupac;
    public FmKupacIzmena(java.awt.Frame parent, boolean modal,  FmKupac kupac) {
       this.kupac=kupac;
        initComponents();
        srediFormu();
    ...
    private void jbtnIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnIzmeniActionPerformed
        ...
        int vrednost = Integer.parseInt(jtxtPib.getText().trim());
         ...
         try {
            Kontroler.vratiInstancuKontrolera().izmeniKupca(k);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FmKupacIzmena.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FmKupacIzmena().setVisible(true);
            }
        });
    }
    ...
    private void srediFormu() {
         centrirajFormu();
        Kupac k = (Kupac) Kontroler.vratiInstancuKontrolera().getMapa().get("kupac_izabran");
        prikaziKupca(k);
    }
    ...
    private void prikaziKupca(Kupac k) {
        jtxtKupacID.setEditable(false);
        jtxtPib.setEditable(false);
        jtxtKupacID.setText(k.getKupacID()+ "");
        jtxtNazi.setText(k.getNaziv());
        jtxtPib.setText(k.getPib()+"");
        //jtxtNazivMesta.setText(k.getMesto().getNazivMesta());
    }
