...
public class FmFaktura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtbFakFiz = new javax.swing.JTable();
        jbtnDetalji = new javax.swing.JButton();
        obrisiKupcaBtn = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        jtbFakFiz.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(jtbFakFiz);
    ...
    private void jbtnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnDetaljiActionPerformed
        int red = jtbFakFiz.getSelectedRow();
        TblModelFaktura model = (TblModelFaktura) jtbFakFiz.getModel();
        FakturaFizickoLice k = model.vratiFakturu(red);
        Kontroler.vratiInstancuKontrolera().getMapa().put("faktura_izabran", k);
        FmFakturaIzmena fki= new FmFakturaIzmena(null, false, this);
        fki.setVisible(true);
    ...
    private void obrisiKupcaBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_obrisiKupcaBtnActionPerformed
        ...
        if (red == -1) {
            ...
            try {
                TblModelFaktura model = (TblModelFaktura) jtbFakFiz.getModel();
                FakturaFizickoLice k = (FakturaFizickoLice) model.vratiFakturu(red);
                Kontroler.vratiInstancuKontrolera().obrisiFakturu(k);
                List<FakturaFizickoLice> lm = Kontroler.vratiInstancuKontrolera().vartiListuFaktura();

                jtbFakFiz.setModel(new TblModelFaktura(lm));

                JOptionPane.showMessageDialog(this, "Faktura je obrisana!!!");
                model.obrisiRed(red);

            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "Faktura nije obrisana!!! " + ex.getMessage());
                ex.printStackTrace();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FmFaktura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable jtbFakFiz;
    ...
    private void srediFormu() {
        ...
        jtbFakFiz.setModel(new TblModelFaktura(lk));
    }
